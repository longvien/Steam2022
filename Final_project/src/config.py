...
class Color:
    ...
    TEXT_INTERNSHIP_REPORT = (241, 222, 179)
    TEXT_CREDIT = (230, 142, 153)
...
class LevelLoadingBarConfig:
    WIDTH: int = 600
    HEIGHT: int = 100
    STEP = 300 if not GameConfig.DEBUG else 10  # how fast the loading bar goes
